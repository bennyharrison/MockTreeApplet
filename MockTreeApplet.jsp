...
/**
  ...
  public static String URLEncodeForLiveConnect(String string)
  {
    byte[] b;
    try {
...
if(Utilities.goodString(ics.GetSSVar("currentpubACLs"))) {
	...
	if(sql != null && sql.hasData())
	{
		...
		for(int i = 0; sql!=null && i < sql.numRows(); i++)
		{
			...
			out.print("<li"+className+"><a href=\"ContentServer?pagename=MockTreeApplet&amp;tabid=" + sql.getValue("id") + "\">" + sql.getValue("title") + "</a></li>");		
